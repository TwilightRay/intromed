...
<html lang="ru" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="dropdown">
          <a name="post" class="userdata" href="#">Консультации врачей</a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="td-p td-pink td-price">800 руб.</td></tr></tbody></table></div>
                      ...
                      <div class="dropdown">
                                          <a name="post" class="userdata" href="#"  >УЗИ диагностика</a>
                                          <ul class="dropdown-list">
                                            <div class="contentBlock">
                                                                        <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
                                <tbody>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Дуплексное сканирование</a>
<ul class="dropdown-list">
                  <div class="contentBlock">
                                              <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
        ...
        <tr>
          ...
          <td class="td-p td-pink td-price">1700 руб.</td></tr></tbody></table></div>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Эндоскопия</a>
<ul class="dropdown-list">
                  <div class="contentBlock">
                                              <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
        ...
        <tr>
          ...
          <td class="td-p td-pink td-price">1500 руб.</td></tr></tbody></table></div>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Физиотерапия</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Массаж</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Дневной стационар</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Урология</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <td class="td-p td-price">1100 / 2000 руб.</td></tr></tbody></table></div>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Гинекология</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Дерматология</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Оториноларингология</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Офтальмология</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <div class="dropdown">
                                          ...
                                          <a name="post" class="userdata" href="#"  >Проктология</a>
<ul class="dropdown-list">
  <div class="contentBlock">
    <div class="objectNote"><table borderColor="#ffffff" cellSpacing="0" cellPadding="0" width="100%" border="0">
      <tbody>
        <tr>
          ...
          <tr>
            ...
            <tr>
              ...
              <a name="post" class="userdata" href="#">Вертебрология</a>
<ul class="dropdown-list">
