...
if ($user['email'] === $email && $user['password'] === $md5Password && $user['email'] === "admin@intromed.com") {
  $_SESSION['admin'] = [
    "id" => $user['id'],
    "name" => $user['name'],
    "email" => $user['email'],
  ...
  header('Location: /');
} else if ($user['email'] === $email && $user['password'] === $md5Password && $user['email'] != "admin@intromed.com") {
  $_SESSION['user'] = [
    "id" => $user['id'],
    "name" => $user['name'],
    "email" => $user['email'],
